...
const navbarLinks = [
  ...
  { label: "Sevicios", href: "/#features", ariaLabel: "Features" },
  { label: "Precios", href: "/#pricing", ariaLabel: "Pricing" },
  { label: "Clientes", href: "/#feedback", ariaLabel: "Feedback" },
];
...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="2xl:w-[1024px] xl:w-3/5 w-4/5 flex justify-between items-center relative">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
